    ...
    <div className="min-h-screen pt-24 pb-16 bg-gray-50 ">
      ...
      <div className="container mx-auto px-4">
        <div data-aos="fade-down">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2 text-center">Partner Universities in China</h1>
            <p className="text-lg text-gray-600 mb-8 text-center">Filter institutions by name, city, or programme to find the best match.</p>
        </div>
        ...
        <div className="mb-10 max-w-2xl mx-auto" data-aos="fade-up">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search by university, city, or programme..."
              value={searchTerm}
        ...
        {loading ? (
          ...
          <div className="text-center text-gray-500 p-6 bg-white rounded-lg shadow-md" data-aos="fade-in">
            ...
            <p>No universities match “{searchTerm}”. Try adjusting your search term or explore all partners below.</p>
          </div>
        ) : (
